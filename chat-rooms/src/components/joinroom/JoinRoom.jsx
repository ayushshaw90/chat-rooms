...
export default function JoinRoom({ joinroom, user }) {
    ...
    <div >
      <div className='bg-amber-300 px-4 py-2'>
        ...
        <div>
          ...
          <button className='bg-orange-400 hover:bg-orange-500 active:bg-orange-600 px-4 py-2 text-xl text-white rounded-lg mx-2 ' onClick={() => { joinroom(code) }}>Enter</button>
        </div>
